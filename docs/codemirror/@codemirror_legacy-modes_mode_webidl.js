async function moduleInitFunction(requireAsyncModule,exports={}){function wordRegexp(words){return new RegExp("^(("+words.join(")|(")+"))\\b")}function readToken(stream,state){// whitespace
