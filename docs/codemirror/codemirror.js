async function moduleInitFunction(requireAsyncModule,exports={}){var view=await requireAsyncModule("@codemirror/view"),state=await requireAsyncModule("@codemirror/state"),language=await requireAsyncModule("@codemirror/language"),commands=await requireAsyncModule("@codemirror/commands"),search=await requireAsyncModule("@codemirror/search"),autocomplete=await requireAsyncModule("@codemirror/autocomplete"),lint=await requireAsyncModule("@codemirror/lint");// (The superfluous function calls around the list of extensions work
...
*/return Object.defineProperty(exports,"EditorView",{enumerable:!0,get:function(){return view.EditorView}}),exports.basicSetup=basicSetup,exports.minimalSetup=minimalSetup,{exports:exports}.exports}